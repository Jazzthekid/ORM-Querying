...
def problem_two(request):
    instructers = Instructor.objects.filter(hire_date__year__lt=2010)
    print('')
    for instructer in instructers:
      print(F'Full Name: {instructer.first_name} {instructer.last_name}') 
      print(f'Hire Date: {instructer.hire_date}')
      print('')
    return complete(request)
...
def problem_three(request):
    instructor= Instructor.objects.get(id__exact=2)
...
def problem_five(request):
    new_student = Student.objects.create(first_name= 'Chante', last_name="Smith", year= 12, gpa=4.0)
...
def problem_six(request):
    new_student = Student.objects.filter(id = 15).update(gpa=3.2)
    updated_student = Student.objects.get(id=15)
    print('')
    print(f'ID: {updated_student.id}') 
    print(f'Full Name: {updated_student.first_name} {updated_student.last_name}')
    print(f'GPA: {updated_student.gpa}')
